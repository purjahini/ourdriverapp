...
public class RegisterActivity extends AppCompatActivity {
    ...
    String spinnergender[], spinnerjob[];
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ArrayAdapter<String> jobSpinner = new ArrayAdapter<>(this, R.layout.spinner, spinnerjob);
    ...
    public String getStringImagektp(Bitmap bmp) {
        ...
        bmp.compress(Bitmap.CompressFormat.JPEG, 20, baos);
        imageByteArrayktp = baos.toByteArray();
        String encodedImage = Base64.encodeToString(imageByteArrayktp, Base64.DEFAULT);
        return encodedImage;
    }
    ...
    public String getStringImagesim(Bitmap bmp) {
        ...
        bmp.compress(Bitmap.CompressFormat.JPEG, 20, baos);
        imageByteArraysim = baos.toByteArray();
        String encodedImage = Base64.encodeToString(imageByteArraysim, Base64.DEFAULT);
        return encodedImage;
    }
...
//sendcode-----------------------
    ...
    private void upload(final String check) {
        ...
        request.setJob(String.valueOf(job.getSelectedItemPosition()));
